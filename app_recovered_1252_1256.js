...
const TRANSLATIONS = {
    ar: {
        ...
        "btn-new-class": "��� ����",
        "btn-new-student": "����� ����",
        "btn-import-excel": "������� ���� (XLSX)",
        "btn-export-class": "����� ��� �����",
        "btn-export-all": "����� �� �������",
        "btn-delete-class-text": "��� �����",
        "roster-panel-title": "������ �����:",
        "badge-boys": "����:",
        "badge-girls": "����:",
        "badge-exempted": "����� ���:",
        ...
        "btn-import-backup": "�������",
        "btn-archive": "����� ���� �����",
        "btn-config-activities": "����� ������� �������� ������",
        "modal-class-title": "����� ��� ����",
        "lbl-class-name": "��� ����� (����: 1 � � � � 1 �� 3 � � 2):",
        "lbl-class-grade": "������� ������� �����:",
        "btn-cancel": "�����",
        "btn-confirm": "����� ����",
        "modal-student-title": "����� / ����� ������ �������",
        ...
        "csv-imported-success": "�� ������� {count} ������ �����!",
        "invalid-csv-format": "��� ������ ��� ������. ���� ������ ����� ������ �������� ������� (����� ����ȡ �����) �� ������ ������.",
        "student-added-success": "�� ����� ������� �����!",
        "student-updated-success": "�� ����� ������ ������� �����!",
        "class-added-success": "�� ����� ����� ������ �����!",
        "backup-imported-success": "�� ������� ������ ���������� �����!",
        "invalid-backup-file": "��� ��������� ��� ����.",
        "no-students-in-class": "�� ���� ������ ������ �� ��� �����.",
        "sport-speed-run": "���� (60�)",
        "sport-endurance": "������ (800� / 600�)",
        "sport-long-jump": "����� ������",
        "sport-shot-put": "��� �����",
        "sport-triple-jump": "����� �������",
        "sport-volleyball": "��� �������",
        ...
        "active-abrv": "����",
        "btn-close": "�����",
        "manual-title": "���� ������� ����� Smart EPS",
        "scale-manager-title": "����� ��� ����� ������� �������",
        "modal-config-activities-title": "����� ������� �������� ������",
        "menu-pedagogical": "����� ����������",
        "title-pedagogical": "������� ���������� ������ ������� �������"
    },
    fr: {
        ...
        "dash-quote-text": "� Un esprit sain dans un corps sain �. L'�ducation physique et sportive (EPS) contribue � forger la personnalit� de l'�l�ve, � renforcer la discipline et � d�velopper les aptitudes physiques.",
        "dash-quick-links": "Raccourcis Rapides",
        "btn-add-student": "Ajouter El�ve",
        "btn-evaluate": "Evaluer Classe",
        "th-class": "Classe",
        "th-students-count": "Nombre d'El�ves",
        ...
        "roster-panel-title": "El�ves de la classe:",
        "badge-boys": "Gar�ons:",
        "badge-girls": "Filles:",
        ...
        "btn-config-activities": "Configurer les Epreuves Sportives",
        ...
        "modal-student-title": "Ajouter / Modifier El�ve",
        ...
        "reset-confirm": "Etes-vous s�r de vouloir tout effacer ? Cette action est irr�versible.",
        ...
        "student-added-success": "El�ve ajout� !",
...
const DEFAULT_DATABASE = {
    metadata: {
        ...
        wilaya: "������ ������� ������ ������� ���",
        messageTemplateExcellent: "������ ����� ��� ��� �������(�) {�����}.\n������� ������! ��� ��� �����/������ ��� ���� ���� ����� �� ���� ������� ������� ��������� �� {�������} ����� {������} (�1: {�1}� �2: {�2}� �3: {�3}). ����� ��/��� ���� ������ �������.\n�� ����� ����� ������.",
        messageTemplateAverage: "������ ����� ��� ��� �������(�) {�����}.\n���� ����� ����� ���� ������� ������� ��������� �� {�������} ����� ������� {�����}. ��� �������(�) ��� ���� ���� ���� {������} (�1: {�1}� �2: {�2}� �3: {�3}). ����� ��/��� ������ �� ���� ���������.\n�� ����� ����� ������.",
        messageTemplateWeak: "������ ����� ��� ��� �������(�) {�����}.\n������ �������� ��� ����� ���� ������� ������� ��������� �� {�������} ����� ������� {�����}.\n���� �����/������ ������ ��� ���� ����� {������} (�1: {�1}� �2: {�2}� �3: {�3}). ���� ���/���� ��� ����� �������� ������� �������� �������.\n�� ����� ����� ������.",
        messageTemplateExempt: "������ ����� ��� ��� �������(�) {�����}.\n��� ������� ��� �����/������ ���� �� ����� ���� ������� ������� ��������� �� {�������} ����� ������� {�����} ����� ����� ���� ������.\n�� ����� ����� ������."
    },
    termActivities: {
    ...
    sports: {
        individual: [
            { id: "speed-run", name: "���� (60�)", unit: "sec", lowerIsBetter: true },
            { id: "endurance-run", name: "������ (800� / 600�)", unit: "sec", lowerIsBetter: true },
            { id: "long-jump", name: "����� ������", unit: "m", lowerIsBetter: false },
            { id: "shot-put", name: "��� �����", unit: "m", lowerIsBetter: false },
            { id: "triple-jump", name: "����� �������", unit: "m", lowerIsBetter: false }
        ],
        collective: [
            { id: "volleyball", name: "��� �������" },
            { id: "handball", name: "��� ����" },
    ...
    classes: [
        { id: "class_1", name: "1 � � � � 1", grade: 1 },
        { id: "class_2", name: "3 � � 2", grade: 3 }
    ],
    students: [
        { id: "std_1", classId: "class_1", firstname: "����", lastname: "�� ���", gender: "M", birthdate: "2010-04-12", phone: "0661122334", exemptions: [false, false, false], order: 0 },
        { id: "std_2", classId: "class_1", firstname: "�����", lastname: "������", gender: "F", birthdate: "2010-08-25", phone: "0770998877", exemptions: [false, false, false], order: 1 },
        { id: "std_3", classId: "class_1", firstname: "�����", lastname: "������", gender: "M", birthdate: "2010-01-05", phone: "0550112233", exemptions: [false, false, false], order: 2 },
        { id: "std_4", classId: "class_1", firstname: "����", lastname: "������", gender: "M", birthdate: "2009-11-15", phone: "0663445566", exemptions: [true, false, false], order: 3 }, // Term 1 Exempted
        { id: "std_5", classId: "class_1", firstname: "����", lastname: "����", gender: "F", birthdate: "2010-09-02", phone: "0772113355", exemptions: [false, false, false], order: 4 },
        
        { id: "std_6", classId: "class_2", firstname: "����", lastname: "����", gender: "M", birthdate: "2008-05-18", phone: "0667332211", exemptions: [false, false, false], order: 0 },
        { id: "std_7", classId: "class_2", firstname: "����", lastname: "�����", gender: "F", birthdate: "2009-02-14", phone: "0771889900", exemptions: [false, false, false], order: 1 },
        { id: "std_8", classId: "class_2", firstname: "��� �����", lastname: "�����", gender: "M", birthdate: "2008-12-30", phone: "0556114422", exemptions: [false, false, false], order: 2 }
    ],
...
const COLLECTIVE_RUBRIC = [
    { code: "A2", score: 20, appreciation: "������", indicator: "���� ����. ����� ����� ����� ������� ������� ���������." },
    { code: "A1", score: 19, appreciation: "�����", indicator: "���� ��� �� ��������. ���� ������ �����." },
    { code: "A", score: 18, appreciation: "�����", indicator: "��� ����� ����. ����� �� ���� ��� �����." },
    { code: "B2", score: 18, appreciation: "��� ����", indicator: "��� ������� �������. ���� ����� �� �������." },
    { code: "B1", score: 17, appreciation: "��� ����", indicator: "���� ������ �� ����� ������� �������� ���������." },
    { code: "B", score: 16, appreciation: "��� ����", indicator: "���� ���� ��� ���������. ����� �� �������� ��������." },
    { code: "C2", score: 15, appreciation: "���", indicator: "���� ��� �� ������ �������. ���� �� �������." },
    { code: "C1", score: 14, appreciation: "���", indicator: "����� �� ������. ���� �������� ������� ������." },
    { code: "C", score: 13, appreciation: "�����", indicator: "����� �� ����� ������� ��������. ���� ���� ������� ���� �����." },
    { code: "D2", score: 12, appreciation: "�����", indicator: "����� ������� �� �������. ����� ��� ��������." },
    { code: "D1", score: 11, appreciation: "�����", indicator: "������ ������ ������. ����� ������� ���� ������." },
    { code: "D", score: 10, appreciation: "�����", indicator: "������ ����� �����. ���� ��� �������� ��������. ����� ����� �����." }
];
...
class SmartEPS {
    ...
    loadDatabase() {
        ...
        if (stored) {
            try {
                ...
                if (!this.database.metadata.wilaya) this.database.metadata.wilaya = "������ ������� ������ ������� ���";
                ...
                if (this.database.dailyLogbook.length === 0) {
                    const defaultClassName = this.database.classes[0] ? this.database.classes[0].name : "1 � � � � 1";
    ...
    undo() {
        if (this.undoStack.length === 0) {
            this.showToast(this.currentLang === "ar" ? "�� ���� ����� ������� ����!" : "Aucune action � annuler !");
            return;
        }
        ...
        try {
            ...
            this.showToast(this.currentLang === "ar" ? "�� ������� �����!" : "Action annul�e avec succ�s !");
        } catch (e) {
    ...
    applyTheme() {
        ...
        if (this.theme === "dark") {
            ...
            if (themeText) themeText.textContent = this.currentLang === "ar" ? "����� ������" : "Mode Jour";
        } else {
            bodyClass.add("light-theme");
            bodyClass.remove("dark-theme");
            if (themeIcon) themeIcon.style.fill = "#3b82f6"; // blue moon
            if (themeText) themeText.textContent = this.currentLang === "ar" ? "����� ����" : "Mode Nuit";
        }
    }
    ...
    applyLanguage() {
        ...
        if (this.currentLang === "ar") {
            ...
            document.getElementById("lang-toggle-btn").innerHTML = "<span>�������</span>";
        }
    ...
    bindGlobalEvents() {
        ...
        const saveMetaSettings = (showToast = false) => {
            ...
            if (showToast) {
                this.showToast(this.currentLang === "ar" ? "�� ��� ������� ������� �����!" : "Param�tres enregistr�s !");
            }
        };
        ...
        document.getElementById("btn-settings-reset").addEventListener("click", () => {
            if (confirm(this.getTranslation("reset-confirm"))) {
                ...
                this.showToast(this.currentLang === "ar" ? "�� ����� ����� ����� �������� ���� ������ �����!" : "Base de donn�es r�initialis�e !");
            }
        });
        ...
        document.getElementById("form-add-student").addEventListener("submit", (e) => {
            ...
            if (!activeClassId) {
                alert(this.currentLang === "ar" ? "���� ����� ��� ����� �����" : "Cr�ez une classe d'abord.");
                return;
            }
        ...
        if (customMinsInput) {
            customMinsInput.addEventListener("change", (e) => {
                ...
                if (!isNaN(mins) && mins > 0) {
                    this.setupFieldTimerMinutes(mins, this.currentLang === "ar" ? "����� ����" : "Temps personnalis�");
                }
            });
        }
    }
        ...
        if (this.database.classes.length === 0) {
            selectors.forEach(sel => {
                if (sel) {
                    ...
                    opt.value = "";
                    opt.textContent = this.currentLang === "ar" ? "-- �� ���� ����� --" : "-- Aucune classe --";
                    sel.appendChild(opt);
                }
            });
            this.activeRosterClassId = "";
    ...
    renderDashboard() {
        ...
        if (this.database.classes.length === 0) {
            leaderboardTbody.innerHTML = `<tr><td colspan="5" class="text-center text-muted">${this.currentLang === "ar" ? "�� ���� ����� ����� ������." : "Aucune classe enregistr�e."}</td></tr>`;
            return;
        }
            ...
            tr.innerHTML = `
                ...
                <td>
                    <button class="btn btn-secondary btn-sm" onclick="app.navigateToClass('${row.id}')">
                        ...
                        <span>${this.currentLang === 'ar' ? '��� �����' : 'D�tails'}</span>
                    </button>
                </td>
            `;
    ...
    renderRosterStudents() {
        ...
        classStudents.forEach((student, index) => {
            ...
            const exLabels = student.exemptions.map((ex, termIdx) => {
                if (ex) return `<span class="badge badge-danger">�${termIdx+1}</span>`;
                return `<span class="badge badge-emerald">�${termIdx+1}</span>`;
            }).join(" ");
            ...
            tr.innerHTML = `
                ...
                <td>
                    <div class="order-btn-col">
                        <button class="order-arrow-btn" onclick="app.moveStudentInRoster('${student.id}', -1)" title="��� ������">
                ...
                <td>
                    <div style="display:flex; gap: 8px;">
                        ...
                        <div class="contact-actions">
                            <button class="contact-icon-btn whatsapp-color" onclick="app.sendMessageToParent('${student.id}', 'whatsapp')" title="����� ��� ��������">
                            ...
                            <button class="contact-icon-btn sms-color" onclick="app.sendMessageToParent('${student.id}', 'sms')" title="����� ����� ���� SMS">
    ...
    openEditStudent(studentId) {
        ...
        if (student) {
            ...
            document.getElementById("modal-student-title-text").textContent = this.currentLang === "ar" ? "����� ������ �������" : "Modifier l'�l�ve";
            document.getElementById("modal-add-student").classList.add("active");
        }
    }

    deleteStudent(studentId) {
        if (confirm(this.currentLang === "ar" ? "�� ��� ����� �� ��� ��� ������п" : "Confirmez-vous la suppression de cet �l�ve ?")) {
    ...
    updateBulkDeleteButton() {
        ...
        if (checkboxes.length > 0) {
            ...
            btnDeleteSelected.innerHTML = `<svg viewBox="0 0 24 24" width="16" height="16" fill="currentColor"><path d="M6 19c0 1.1.9 2 2 2h8c1.1 0 2-.9 2-2V7H6v12zM19 4h-3.5l-1-1h-5l-1 1H5v2h14V4z"/></svg> ��� ������ (${checkboxes.length})`;
        } else {
    ...
    deleteSelectedStudents() {
        ...
        if (confirm(this.currentLang === "ar" ? `�� ��� ����� �� ��� ${checkboxes.length} �����п` : `Confirmez-vous la suppression de ${checkboxes.length} �l�ves ?`)) {
            ...
            this.saveDatabase();
            this.renderActiveViewContent();
            this.showToast(this.currentLang === "ar" ? "�� ����� �����" : "Suppression r�ussie");
        }
    }
    ...
    renderGradingSheet() {
        ...
        if (activeTerm === "annual") {
            if (indSportBadge) indSportBadge.textContent = "������";
            if (colSportBadge) colSportBadge.textContent = "������";
        } else {
    ...
    printGradingSheet() {
        ...
        if (activeTerm === "annual") {
            ...
            const type = this.activeGradingType;
            if (type === "continuous") printTitleBase = "���� ����� �������� �������� ����� " + activeTerm;
            else if (type === "assignment") printTitleBase = "��� ���� ����� ����� ����� " + activeTerm;
            else if (type === "exam") printTitleBase = "��� ���� �������� ����� " + activeTerm;
            else if (type === "term-summary") printTitleBase = "��� ���� ����� " + activeTerm;
        }
        
        const title = `${printTitleBase} - ���: ${activeClass.name}`;
        ...
        let headers = `
            <thead>
                <tr>
                    ...
                    <th style="width: 200px;" class="text-center">7 ��� ���� ���� (14 �)</th>
                    <th style="width: 80px;" class="text-center">�������� (2�)</th>
                    <th style="width: 80px;" class="text-center">�������� (2�)</th>
                    <th style="width: 80px;" class="text-center">������� (2�)</th>
                    <th style="width: 80px;" class="text-center">����� (20)</th>
                </tr>
            </thead>
            <tbody>
        `;
        ...
        let headers = `
            <thead>
                <tr>
                    ...
                    <th style="white-space: nowrap; padding: 0 10px;">${this.getTranslation("th-student-firstname")}</th>
                    <th>${this.getTranslation("th-gender")}</th>
                    <th colspan="3" class="text-center">������ ������: ${indSportName} (3 �������)</th>
                    <th style="width: 90px;" class="text-center">�. ������</th>
                    <th style="width: 160px;" class="text-center">�. �������: ${colSportName}</th>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="collective-grade-container">
                                ...
                                <select class="rubric-select" data-student="${student.id}" style="width: 60px; font-family: inherit; font-size: 0.75rem; padding: 2px;" title="���� ��� ������� ������� ��������">
                                    <option value="">--</option>
                                    ${rubricOptions}
                                </select>
                            </div>
        ...
        let headers = `
            <thead>
                <tr>
                    ...
                    <th class="text-center">����� (/20)</th>
                    <th class="text-center">�������� (/20)</th>
                    <th class="text-center" style="width: 110px;">���� ����� ${term}</th>
            ...
            if (isExemptedAll) {
                headers += `
                    <tr class="exempted-row">
                        ...
                        <td class="text-center"><span class="badge badge-danger">����</span></td>
                        <td class="text-center"><span class="badge badge-danger">����</span></td>
                        <td class="text-center"><strong class="highlight-text">����� ���</strong></td>
                        <td class="text-center">--</td>
                    </tr>
                `;
            } else {
                ...
                const formatAvg = (avg) => avg !== null ? avg.toFixed(2) : '<span class="badge badge-danger">����</span>';
    ...
    calculateStudentAnnualAverage(studentId) {
        ...
        if (activeTerms.length === 0) {
            return { value: null, label: this.getTranslation("exempted-abrv") }; // "����"
        }
    ...
    loadScaleValuesToModal() {
        ...
        if (scale) {
            ...
            const bestLbl = this.currentLang === "ar" ? "���� ������ ������ (���� 20/20):" : "Performance Max (donne 20/20) :";
            const worstLbl = this.currentLang === "ar" ? "���� ������ ������ (���� 05/20):" : "Performance Min (donne 05/20) :";
    ...
    printCollectiveRubric() {
        ...
        const printWindow = window.open("", "_blank");
        if (!printWindow) {
            alert(this.currentLang === "ar" ? "���� ������ �������� �������� ������ �����!" : "Veuillez autoriser les popups pour imprimer !");
            return;
        }
                ...
                <table class="header-table">
                    <tr>
                        ...
                        <td style="text-align: left; width: 50%; vertical-align: top; direction: ltr;">
                            <strong>����� ��������:</strong> ${academicYear}<br>
                            <strong>����� ������:</strong> ${teacherName}
                        </td>
                    </tr>
                </table>
    ...
    printAllScales() {
        ...
        const sportObj = this.database.sports.individual.find(s => s.id === sportId) || { name: "���� (60�)", unit: "sec" };
        const sportName = sportObj.name;
        const unitLabel = (sportObj.unit === "sec") ? "�����" : "���";
        ...
        const content = `
            ...
            <body>
                ...
                <div class="section-title">������ ������� ������: ${sportName} - ������� �������: ${gradeLabel}</div>
                ...
                <div class="section-title collective">��� ����� ������� ������ ������� �������� (���� ����� �������� �������� �������)</div>
                <p style="margin: 0 0 6px 0; font-size: 0.74rem; color: #444;">
                    ������: ��� ����� ���� ������ ������ ������ ���� �������� �������� ���������� ���������.
                </p>
    ...
    downloadCollectiveRubricExcel() {
        try {
            ...
            this.showToast(this.currentLang === "ar" ? "�� ����� ��� ������ �����!" : "Fichier Excel t�l�charg� avec succ�s !");
        } catch (error) {
            console.error("Error exporting collective rubric to Excel:", error);
            alert(this.currentLang === "ar" ? "��� ����� ����� ���� ����!" : "Echec de l'exportation du bar�me en Excel !");
        }
    }
    ...
    sendMessageToParent(studentId, gateway) {
        ...
        if (!student || !student.phone) {
            alert(this.currentLang === "ar" ? "��� ���� ����� ��� ����� �������!" : "T�l. parent non disponible !");
            return;
        }
        ...
        msg = msg.replace(/{�����}/g, `${student.lastname} ${student.firstname}`);
        msg = msg.replace(/{�������}/g, school);
        msg = msg.replace(/{�����}/g, year);
        msg = msg.replace(/{�1}/g, t1Text);
        msg = msg.replace(/{�2}/g, t2Text);
        msg = msg.replace(/{�3}/g, t3Text);
        msg = msg.replace(/{������}/g, annualText);
        ...
        let html = `
            <div class="print-page" style="page-break-after: always; padding: 20px; font-family: 'Cairo', sans-serif; direction: rtl;">
                <div style="text-align: center; margin-bottom: 20px; border-bottom: 2px solid #000; padding-bottom: 10px;">
                    ...
                    <h2 style="margin: 15px 0 5px 0;">����� ������ �����: ${cls.name}</h2>
                </div>
                <table style="width: 100%; border-collapse: collapse; text-align: right; font-size: 0.9rem;">
                    <thead>
                        <tr style="background: #f3f4f6;">
                            ...
                            <th style="border: 1px solid #000; padding: 8px;">�����</th>
                            <th style="border: 1px solid #000; padding: 8px; width: 60px; text-align: center;">�����</th>
                            <th style="border: 1px solid #000; padding: 8px;">����� �������</th>
                            <th style="border: 1px solid #000; padding: 8px; width: 80px; text-align: center;">������</th>
                            <th style="border: 1px solid #000; padding: 8px;">�������</th>
                        </tr>
                    </thead>
                    <tbody>
                        ${classStudents.map((s, idx) => {
                            ...
                            <tr>
                                ...
                                <td style="border: 1px solid #000; padding: 6px; text-align: center;">${isExempted ? "����" : "����"}</td>
    ...
    handleExcelFileSelect(file) {
        ...
        reader.onload = (e) => {
            try {
                ...
                alert(this.currentLang === "ar" ? "��� ��� ����� ����� ��� ������. ���� ������ �� ������ ����� ������ (xlsx �� xls)." : "Erreur lors de la lecture du fichier Excel.");
            }
        };
    ...
    parseAndImportExcelRows(rows) {
        ...
        if (!activeClassId) {
            alert(this.currentLang === "ar" ? "���� ������ ����� �����!" : "S�lectionnez une classe.");
            return;
        }
        ...
        headers.forEach((header, idx) => {
            const h = header.trim();
            if (h.includes("�����") || h.includes("nom") || h.includes("last") || h.includes("surname")) {
                lastnameIdx = idx;
            } else if (h.includes("�����") || h.includes("prenom") || h.includes("pr�nom") || h.includes("first") || h.includes("name")) {
                firstnameIdx = idx;
            } else if (h.includes("�����") || h.includes("genre") || h.includes("gender") || h.includes("sexe") || h.includes("���")) {
                genderIdx = idx;
            } else if (h.includes("�����") || h.includes("birth") || h.includes("date") || h.includes("naissance") || h.includes("�����") || h.includes("������")) {
                birthdateIdx = idx;
            }
        });
        ...
        for (let i = 1; i < cleanRows.length; i++) {
            ...
            if (gender.includes("�") || gender.includes("M") || gender.includes("GAR") || gender === "���") {
                gender = "M";
            } else {
                gender = "F";
            }
    ...
    archiveAndNewYear() {
        if (confirm(this.currentLang === "ar" 
            ...
            this.populateClassDropdowns();
            this.switchTab("dashboard");
            this.showToast(this.currentLang === "ar" ? "�� ����� ����� ������ ����� ��������!" : "Ann�e archiv�e et base de donn�es nettoy�e !");
        }
    }
    ...
    addNewSport() {
        ...
        if (!name) {
            alert(this.currentLang === "ar" ? "���� ����� ��� ������ �������!" : "Veuillez entrer le nom du sport !");
            return;
        }
        ...
        if (type === "individual") {
            ...
            if (isNaN(mBest) || isNaN(mWorst) || isNaN(fBest) || isNaN(fWorst)) {
                alert(this.currentLang === "ar" ? "���� ����� ���� ��� ����� ������ �������!" : "Veuillez remplir toutes les valeurs du bar�me !");
                return;
            }
        ...
        this.showToast(this.currentLang === "ar" ? "�� ����� ������ ������� �����!" : "Sport ajout� avec succ�s !");
    }
    ...
    updatePrintHeader() {
        ...
        if (this.activeTab === "grading") {
            ...
            termLabel = activeTerm === "1" ? "����� �����" : activeTerm === "2" ? "����� ������" : "����� ������";
    ...
    renderCahierJournalList() {
        ...
        if (entries.length === 0) {
            tbody.innerHTML = `<tr><td colspan="6" style="text-align: center; color: var(--text-secondary); padding: 20px;">${this.currentLang === "ar" ? "�� ���� ��� ����� ������." : "Aucune s�ance enregistr�e."}</td></tr>`;
            return;
        }
    ...
    saveCahierJournalEntry() {
        ...
        if (!date || !className || !sport || !objective) {
            alert(this.currentLang === "ar" ? "���� ��� ���� ������ ��������!" : "Veuillez remplir tous les champs obligatoires !");
            return;
        }
        ...
        this.renderPedagogicalView();
        this.showToast(this.currentLang === "ar" ? "�� ����� ����� ������ ������ �����!" : "S�ance enregistr�e dans le cahier journal !");
    }

    deleteCahierJournalEntry(entryId) {
        if (!confirm(this.currentLang === "ar" ? "�� ��� ����� �� ��� ��� ����� �� ������ ������" : "Voulez-vous vraiment supprimer cette s�ance ?")) {
            return;
        }
        this.database.dailyLogbook = (this.database.dailyLogbook || []).filter(e => e.id !== entryId);
        this.saveDatabase();
        this.renderPedagogicalView();
        this.showToast(this.currentLang === "ar" ? "�� ��� ����� �����!" : "S�ance supprim�e !");
    }
    ...
    updatePortfolioStatus() {
        ...
        if (cahierStatus) {
            cahierStatus.textContent = this.currentLang === "ar" ? `${logbookCount} ��� �����` : `${logbookCount} s�ances`;
        }
        ...
        if (medicalStatus) {
            medicalStatus.textContent = this.currentLang === "ar" 
                ? `${exemptCount} ������ / ${totalStudents - exemptCount} �����` 
        ...
        if (gradesStatus) {
            gradesStatus.textContent = this.currentLang === "ar" ? `����� ����� ${percent}%` : `Compl�t� � ${percent}%`;
        }
    }
    ...
    renderActiveCycleTable() {
        ...
        let html = `
            <div style="background: rgba(0, 0, 0, 0.2); border-radius: 8px; border: 1px solid var(--border-color); padding: 15px; margin-bottom: 15px; display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 10px;">
                <div>
                    <h3 style="margin: 0; color: #fff; font-size: 1.05rem;">������ ������� ����� ${term} - �������: ${gradeLabel}</h3>
                    <p style="margin: 5px 0 0 0; font-size: 0.8rem; color: var(--text-secondary);">������ ����� (����): <strong style="color: var(--color-primary);">${sport1}</strong> | ������ ������ (����): <strong style="color: var(--color-gold);">${sport2}</strong></p>
                </div>
                <span class="badge-emerald" style="font-size: 0.72rem; padding: 6px 12px; font-weight: 700;">8 ��� ������ (��������)</span>
            </div>
                ...
                <table class="interactive-table" style="width: 100%; border-collapse: collapse;">
                    <thead>
                        <tr>
                            ...
                            <th style="width: 250px; text-align: right; padding-right: 15px;">����� ������� ��������</th>
                            <th style="text-align: right; padding-right: 15px;">�������� �������� (${sport1})</th>
                            <th style="text-align: right; padding-right: 15px;">�������� �������� (${sport2})</th>
    ...
    generateFichePreview() {
        ...
        const sportName = document.getElementById("fiche-select-sport").options[document.getElementById("fiche-select-sport").selectedIndex]?.text || "��� ����";
        const gradeLabel = grade === "1" ? "����� ������ ����� (1AS)" : grade === "2" ? "����� ������� ����� (2AS)" : "����� ������� ����� (3AS)";
                ...
                <div style="border: 2px double var(--border-color); padding: 20px; border-radius: 8px;">
                    <div style="display: flex; justify-content: space-between; align-items: center; border-bottom: 1.5px solid var(--border-color); padding-bottom: 12px; margin-bottom: 15px;">
                        <div style="text-align: right; font-size: 0.8rem; line-height: 1.5;">
                            <div><strong>�������:</strong> <span contenteditable="true">${this.database.metadata.schoolName || ""}</span></div>
                            <div><strong>����� ������:</strong> <span contenteditable="true">${this.database.metadata.teacherName || ""}</span></div>
                        </div>
                        <div style="text-align: center;">
                            <h2 style="margin: 0; font-size: 1.25rem; color: var(--color-primary); font-weight: 800;" contenteditable="true">����� ����� ��������� �����</h2>
                            <span class="badge-emerald" style="font-size: 0.76rem; font-weight: 700; margin-top: 4px; display: inline-block;">����� ����� �����</span>
                        </div>
                        <div style="text-align: left; font-size: 0.8rem; line-height: 1.5;">
                            <div><strong>������� �������:</strong> <span contenteditable="true">${gradeLabel}</span></div>
                            <div><strong>������ �������:</strong> <span contenteditable="true">${this.database.metadata.academicYear || ""}</span></div>
                        </div>
                    </div>
                    ...
                    <div style="background: rgba(255, 255, 255, 0.01); border: 1px solid var(--border-color); padding: 12px; border-radius: 6px; margin-bottom: 20px; font-size: 0.85rem; line-height: 1.6;">
                        <div style="display: flex; justify-content: space-between; flex-wrap: wrap; gap: 10px; margin-bottom: 8px;">
                            <div style="flex: 1; min-width: 200px;"><strong>������ �������:</strong> <span contenteditable="true" style="color: var(--color-primary); font-weight: 700;">${sportName}</span></div>
                            <div style="flex: 1; min-width: 200px;"><strong>������� ���:</strong> <span contenteditable="true" style="font-family: 'Outfit'; font-weight: 700;">${sessionNum}</span></div>
                            <div style="flex: 1; min-width: 150px;"><strong>��� �����:</strong> <span contenteditable="true">60 �����</span></div>
                        </div>
                        <div style="margin-bottom: 8px;"><strong>������� ��������:</strong> <span contenteditable="true" style="color: var(--text-secondary);">${ficheData.finalCompetency}</span></div>
                        <div style="margin-bottom: 8px;"><strong>������� ��������:</strong> <span contenteditable="true" style="color: var(--text-secondary);">${ficheData.baseCompetency}</span></div>
                        <div><strong>����� �������� �����:</strong> <span contenteditable="true" style="color: var(--color-gold); font-weight: 700;">${ficheData.sessionObjective || sessionNum}</span></div>
                    </div>

                    <div style="margin-bottom: 20px;">
                        <h3 style="margin: 0 0 10px 0; font-size: 0.95rem; color: var(--color-primary); border-right: 3.5px solid var(--color-primary); padding-right: 8px;">1. ������� ��������� (������� ��������) - �����: 15 �����</h3>
                        <table style="width: 100%; border-collapse: collapse; font-size: 0.78rem; text-align: right; border: 1px solid var(--border-color);">
                            <thead>
                                <tr style="background: var(--color-primary-soft); color: var(--color-primary);">
                                    <th style="border: 1px solid var(--border-color); padding: 6px; width: 250px;">������ ������ ��������</th>
                                    <th style="border: 1px solid var(--border-color); padding: 6px; width: 80px; text-align: center;">�����</th>
                                    <th style="border: 1px solid var(--border-color); padding: 6px;">����� ������� ����� �������</th>
                                    <th style="border: 1px solid var(--border-color); padding: 6px; width: 150px; text-align: center;">������ ������ ��������</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                    ...
                                    <td contenteditable="true" style="border: 1px solid var(--border-color); padding: 8px; text-align: center; vertical-align: middle; font-weight: 700;">15 �����</td>
                    ...
                    <div style="margin-bottom: 20px;">
                        <h3 style="margin: 0 0 10px 0; font-size: 0.95rem; color: var(--color-gold); border-right: 3.5px solid var(--color-gold); padding-right: 8px;">2. ������� �������� (������ ��������� �����������) - �����: 40 �����</h3>
                        <table style="width: 100%; border-collapse: collapse; font-size: 0.78rem; text-align: right; border: 1px solid var(--border-color);">
                            <thead>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td contenteditable="true" style="border: 1px solid var(--border-color); padding: 8px; text-align: center; vertical-align: middle; font-weight: 700;">40 �����</td>
                    ...
                    <div style="margin-bottom: 25px;">
                        <h3 style="margin: 0 0 10px 0; font-size: 0.95rem; color: var(--color-blue); border-right: 3.5px solid var(--color-blue); padding-right: 8px;">3. ������� �������� (������� ����������) - �����: 05 �����</h3>
                        <table style="width: 100%; border-collapse: collapse; font-size: 0.78rem; text-align: right; border: 1px solid var(--border-color);">
                            <thead>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td contenteditable="true" style="border: 1px solid var(--border-color); padding: 8px; text-align: center; vertical-align: middle; font-weight: 700;">05 �����</td>
    ...
    getFicheTemplateData(sportId, grade, sessionNum) {
        ...
        if (sportId === "handball" || sportId.includes("hand")) {
            if (num === 1) {
                sessionObjective = "�� ����� ������� ����� ������ �� ����� ������ ������ ������� ���� ����.";
                p1Situations = "����� ���: ��� ���� ��� ������ �� ����� ���� ������ (5�).<br>����� ���: ����� �� ����� �������� �������� ����� ���� ����� ������� ���� ����� (10�).";
                p1Org = "������ �� ���� ������ɡ ����� ����� ������ 3 �����.";
                p1Crit = "��� ��� ����� ���� ����� ������ �������� �������.";
                
                p2Situations = "�1: ����� �������� ��� 04 ����� ������� ������ ������ �� ����� (����ء ��� �����) (25�).<br>�2: ���� ��������� ����� �� ��� ���� ��� ����� �� ������ ����� ����� (25�).<br>�3: ������ ������� ����� ��� ������� �� ��� ����� ����� ���� ���� ��� ����� ��� ������� (30�).";
                p2Org = "������� ���� ��� ���ϡ 4 ���ʡ �����ʡ ����� ����� ������ ����� �����.";
                p2Crit = "��� ���� ����� ��� ����֡ �������� ��� �������� ����� �������� ��������.";
                
                p3Situations = "������ ��� ������ ��������: ��� ���� ��� ������ ����� ���� ���� (10�).<br>������ ������� ����� ���� ������� ������� �������ɡ ������ �������� ��������� (10�).";
                p3Org = "������ ��� ������� ��� ��� ���� ����� ��������� ����� ���.";
                p3Crit = "������� ����� ������ ������� ������� �������.";
            } else if (num === 2) {
                sessionObjective = "�� ���� ������� ����� ���� ���� ������ ��� ����� ����� �������� �������� ������.";
                ...
                p2Situations = "�1: ����� ������ �� ������� ������ �� ����� �������� ���� ���� �� ���� ������� (25�).<br>�2: ������� ������� ������: ����� ����� ������ �� ������ �������� ��� ������ �� ���� �� 6 ����� (25�).<br>�3: ������ ������� ��� ������� �� ������� ��� ���� �������� ������� (Fast Break) (30�).";
                p2Org = "����� ������ ������ ���� �� ��� ����ȡ ����� ��� �� 6� ������ ����� �������.";
                p2Crit = "��� ������� ����� ������ ��������� ������ ��� �������.";
                
                p3Situations = "��� ���� �� �������� ����� ������� �������� ������� (10�).<br>����� ����� �������� ������� ����� ������ ������� ������ ��������� (10�).";
                p3Org = "������ �� ���� ����� �������.";
                p3Crit = "������� ����� ����� �������� �������.";
            } else {
                sessionObjective = "����� ������� ������� ������ �������� ��������� ��� ������� ������� 6:0.";
                p1Situations = "����� ���: ��� ����� ���� ������� ��� ����� ������� (5�).<br>����� ���: ����� ������ �������� ������ ������ ���� ����� (10�).";
                p1Org = "�������� ��� �� 9 �����.";
                p1Crit = "����� ������ ������� �������.";
                
                p2Situations = "�1: ���� ������ ������ ������� ������ �� 6 ����� ������� ������ ������� ������ ���� ����� (25�).<br>�2: ����� ���� �� ����: 5 ������� �� 4 ������� ������� ��� ����� ����� ������� (25�).<br>�3: ������ ��� ������� �� ������ ������ ������ ����� ������ (30�).";
                p2Org = "������� ��� �����ȡ ����ա ����.";
                p2Crit = "������� ������� ������ �� ������ ���� ������� �� �������.";
            ...
            sessionObjective = "�� ���� ������� ������� ������ �������� �� ������ ����� ������ ������ �� ������ ������� �������.";
            p1Situations = "����� ���: ����� ��� ������� �� ��� �������� ���� ����� �������� (5�).<br>����� ���: ����� ����� ������ ������ �������� ��������ǡ ����� ����� ����� �������� (10�).";
            p1Org = "������ �� ���� ����͡ ���� ����� ��� �������.";
            p1Crit = "����� ����� ���� ������ ������ �������.";
            
            p2Situations = "�1: ����� ������� ����� �� ������ �������� ������� ��� ������ ���� ������ (30�).<br>�2: ������� ������� �� ������� ������� ��������� ������� ����� ������ �� ������ 3 (20�).<br>�3: ������ ������� ����� ������ �� �������� �������� ������ ��� ��� ��� ������ (30�).";
            p2Org = "���� ��� ����ɡ ���� ����� ��������� ������ ���� ����ɡ �����.";
            p2Crit = "������ ����� �������� ��� �� ������� ������ ������ ��������� ���������.";
            
            p3Situations = "������ ������� ����� ����� ��������� �� ����� ������ (10�).<br>������ ������� ��������� ������ ������� �� �����ȡ ������ ��������� (10�).";
            p3Org = "������ ��� �� ����� ������ �����.";
            p3Crit = "������ ���� ����� ����� �������� ������.";
        } else if (sportId === "basketball" || sportId.includes("basket")) {
            sessionObjective = "����� ������� ������ ����� ������ ������ ������� ��������� ������ ������ Double-pas.";
            p1Situations = "����� ���: ��� ������� �� ����� ������� ������ ��� ���� ������� (5�).<br>����� ���: ����� ������ ����� �������� ������� ������ ������� (10�).";
            p1Org = "����� �������� ��� ��� ���� ��� �����.";
            p1Crit = "������ �� ����� ������� ���� ������ ��� �����.";
            
            p2Situations = "�1: ����� ������� �������� ������ ����� ������ ����� �� ������ ��� ����� ������� (25�).<br>�2: ������� ��� ����� �������� ��� Double-pas (����-����-������ ������ ������ �������� ����� ������) (25�).<br>�3: ������ ������� ��� ����� �� ��� ����� ������� ��� �������� ������� �������� ������ (30�).";
            p2Org = "���� ��� ����ɡ ���� ���� ����ȡ ����� ������ ����� ��������.";
            p2Crit = "��� ������ ��� ��� �������� ������ �������� ������� ������� �������.";
            ...
            p2Situations = "�1: ������� ��� ����� �������� ������� (�� ����ߡ ����ϡ �����) �� ������ ����� (25�).<br>�2: ������ ���� ����� (20� �� 30�) ����� ��� ��������� �������� ������� �������� (25�).<br>�3: ������ ����� �� ����� ������ ������ 60� ����� �������� �������� �� ���� ������� (30�).";
            p2Org = "����� ����� ������ ���� ����ɡ ����� �����.";
            p2Crit = "�������� ������ ����� ��� �������� ���� ��� ����� ������.";
            
            p3Situations = "��� ���� ���� ����� ������� ������� ������� ������� ����� (15�).<br>����� ��������� ������� ������ ��������ʡ ������ ��������� (5�).";
            p3Org = "������ ����� ��� ����� �� �����.";
            p3Crit = "���� ����� �������� �������.";
        } else {
            sessionObjective = `������ �� �������� �������� ������ ������� ������� �� ���� ${sportName}.`;
            p1Situations = "����� ���: ��� ���� ������ ������� ������� (5�).<br>����� ���: ������� ����� �������� ��������� ������� ������ �������� ������ (10�).";
            p1Org = "�������� �� ���� ����� �������.";
            p1Crit = "��������� ������ ������� ������ �������.";
            
            p2Situations = `�1: ����� ������ ���� ������� �������� ����� ${sportName} �������� ������� �������� (30�).<br>�2: ����� ���� ������ ������� �� ���� ����� ����� ������ ������� (25�).<br>�3: ������ ����� ������ �������� ��������� ������� ������ ������ ������� �������� (25�).`;
            p2Org = "������� ������ ������� �������� (����ա ������ ���ʡ ����� ����).";
            p2Crit = "����� ������� ������ ���� ��������� ��� �������� ������ ��������.";
            
            p3Situations = "��� ���� ��� ������ ��������� ����� (10�).<br>������� ������� ������ ��������ʡ ������ �������� ��������� (10�).";
            p3Org = "���� �� ���� ����� ������� ������.";
            p3Crit = "��� ����� ����� ���� �������� �������.";
        }
        ...
        printWindow.document.write(`
            ...
            <body>
                <div class="fiche-container">
                    <table class="header-table">
                        <tr>
                            <td style="width: 35%; text-align: right;">
                                ...
                                <div>����� ������� �������</div>
                                <div>${wilaya}</div>
                                <div><strong>�������:</strong> ${schoolName}</div>
                            </td>
                            <td style="width: 30%; text-align: center; vertical-align: middle;">
                                <h1 class="title-doc">����� ��������� ������</h1>
                                <div style="font-size: 0.9rem; font-weight: 700; margin-top: 5px;">����� ���: ${sessionNum}</div>
                            </td>
                            <td style="width: 35%; text-align: left;">
                                <div><strong>����� ������:</strong> ${teacherName}</div>
                                <div><strong>�������:</strong> ${gradeLabel}</div>
                                <div><strong>������ �������:</strong> ${academicYear}</div>
                                <div><strong>��� �����:</strong> 120 ����� (������)</div>
                            </td>
                        </tr>
                    </table>
                    ...
                    <div class="meta-box">
                        <div class="meta-grid">
                            <div><strong>������ �������:</strong> <span style="font-weight: 700;">${sportName}</span></div>
                            <div><strong>����� �������� �����:</strong> <span style="font-weight: 700;">${ficheData.sessionObjective}</span></div>
                        </div>
                        <div><strong>������� ��������:</strong> ${ficheData.finalCompetency}</div>
                        <div style="margin-top: 5px;"><strong>������� ��������:</strong> ${ficheData.baseCompetency}</div>
                    </div>
                    ...
                    <div class="section-title">2. ������� �������� (������ ���������) - �����: 80 �����</div>
                    <table class="phase-table">
                        <thead>
                            <tr>
                                <th style="width: 35%;">������ ������ ��������</th>
                    ...
                    <div class="section-title">3. ������� �������� (������� ����������) - �����: 20 �����</div>
                    <table class="phase-table">
                        <thead>
                            <tr>
                                <th style="width: 35%;">������ ������ ��������</th>
                ...
                <div class="sheet">
                    <div class="header-box">
                        ...
                        <div style="text-align: left;">
                            <div><strong>����� ������:</strong> ${teacherName}</div>
                            <div><strong>������ �������:</strong> ${academicYear}</div>
                            <div><strong>����� �����:</strong> <span style="font-family: 'Outfit'; font-weight: 700;">${entry.date}</span></div>
                        </div>
                    </div>
        ...
        printWindow.document.write(`
            ...
            <body>
                ...
                <div style="text-align: center; margin: 20px;" class="no-print">
                    <button onclick="window.print()" style="padding: 10px 20px; font-size: 1rem; background: #10b981; color: white; border: none; border-radius: 5px; cursor: pointer; font-family: 'Cairo', sans-serif;">����� ������</button>
                    <p style="margin-top: 10px; font-size: 0.9rem; color: #666;">����� ������� ��� ����� ������ ������ ��� ������� ������ ��� �������.</p>
                </div>
                <style>
                    @media print {
                        .no-print { display: none !important; }
            ...
            <body>
                <div class="page">
                    <div class="cover-page">
                        <div>
                            <div style="font-size: 1.15rem; font-weight: 700;">��������� ��������� ����������� �������</div>
                            <div style="font-size: 1.05rem; font-weight: 700; margin-top: 5px;">����� ������� �������</div>
                ...
                <div class="page" style="border: 1px solid #ddd; padding: 30px;">
                    ...
                    <div class="info-p">
                        ...
                        <ul>
                            <li><strong>������� ������:</strong> ��� ��� ������� ����� �������� ����������� (����� ����� ������) ��� ��� ���� ������ ������� ������ ������� �������� ������ �����������.</li>
                            <li><strong>����� ������� �������:</strong> ����� �������� ���� ��� �������� ������� ������� ������� ������ ������� ����� ������ ���� ������ ����� ������ ������ ������.</li>
                            <li><strong>������ ������:</strong> ��� ������ ������ ����� ������ ��������� ����� ���� ���� ������� ����� ����� ����ա �������� ��������ɡ ����� �������� ������� �� ������� ������ ������� ��� ������ �� ���.</li>
                            <li><strong>������� ������� ��������:</strong> �������� �������� ������� �������� �� ����� ������� �������� ������� ������ ������̡ ������ ������ ��������� ���� ����� ����� ������� ������� �������.</li>
                        </ul>
                    </div>
                ...
                <div class="page" style="border: 1px solid #ddd; padding: 30px;">
                    <div class="section-title">��� ���� ������ ������ ������� (Daily Logbook)</div>
                    <div class="info-p">
                        ����� ������ ����� ��� ����� ����� �������� ������� �������� �� ��� ������� �� ������ ������ ����� ����� ������:
                    </div>
                    <table class="table-data">
                        ...
                        <tbody>
                            ${logbook.length === 0 ? `
                                <tr><td colspan="5" style="text-align: center; padding: 20px;">�� ���� ��� ����� ������� ������ ������.</td></tr>
                            ` : logbook.map(e => `
                                <tr>
                                    ...
                                    <td>
                                        <strong>�����:</strong> ${e.objective}<br>
                                        <strong>��������:</strong> ${e.situations || "---"}
                                    </td>
    ...
    toggleFieldTimer() {
        if (this.isTimerRunning) {
            ...
            this.isTimerRunning = false;
            document.getElementById("timer-toggle-text").textContent = this.currentLang === "ar" ? "����� ������" : "D�marrer";
            document.getElementById("timer-play-svg").innerHTML = `<path d="M8 5v14l11-7z"/>`;
        } else {
            this.isTimerRunning = true;
            document.getElementById("timer-toggle-text").textContent = this.currentLang === "ar" ? "����� ����" : "Pause";
            ...
            this.timerInterval = setInterval(() => {
                if (this.timerCurrentSeconds > 0) {
                    ...
                    this.showToast(this.currentLang === "ar" ? "����� ��� ������� �����������!" : "Temps de phase �coul� !");
                }
            }, 1000);
        }
    }
