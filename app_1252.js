...
class SmartEPS {
    ...
    generateDigitalDiploma(studentId, term) {
        ...
        ctx.fillText("★ Smart EPS ★", 250, 660);
    ...
    getDailyPedagogicalGuidance() {
        const sportsQuotes = [
            ...
            "\u0627\u0644\u0645\u0648\u0647\u0628\u0629\u0020\u062a\u0648\u0641\u0631\u0020\u0644\u0633\u0643\u0020\u0627\u0644\u0641\u0631\u0635\u0629\u060c\u0020\u064ل\u0643\u0646\u0020\u0627\u0644\u0639\u0645\u0644\u0020\u0627\u0644\u062c\u0645\u0627\u0639\u064a\u0020\u0648\u0627\u0644\u0631\u0648\u062d\u0020\u0627\u0644\u0631\u064a\u0627\u0636\u064a\u0629\u0020\u064a\u0635\u0646\u0639\u0627\u0646\u0020\u0627\u0644\u0641\u0627\u0631\u0642\u002e",
    ...
    printCollectiveRubric() {
        ...
        const content = `
            ...
            <head>
                <meta charset="UTF-8">
                <title>سلم تنقيط الألعاب الجماعية - Smart EPS</title>
    ...
    printAllScales() {
        ...
        const content = `
            ...
            <head>
                <meta charset="UTF-8">
                <title>سلم تنقيط التربية البدنية والرياضية - Smart EPS</title>
                <link rel="preconnect" href="https://fonts.googleapis.com">
                <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
                <link href="https://fonts.googleapis.com/css2?family=Cairo:wght@400;600;700;800&display=swap" rel="stylesheet">
                <style>
    ...
    exportRosterToExcel() {
        ...
        const ws_data = [
            ["الاسم", "اللقب", "الجنس", "تاريخ الميلاد", "الهاتف", "إعفاء ف1", "إعفاء ف2", "إعفاء ف3"]
        ];
                ...
                <div class="page">
                    <div class="cover-page">
                        ...
                        <div style="font-size: 0.85rem; font-style: italic; color: #4b5563;">
                            تم التوليد رقمياً بواسطة منصة Smart EPS الذكية
                        </div>
                    </div>
                </div>
