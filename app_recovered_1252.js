...
class SmartEPS {
    ...
    deleteStudent(studentId) {
        if (confirm(this.currentLang === "ar" ? "?? ??? ????? ?? ??? ??? ????????" : "Confirmez-vous la suppression de cet �l�ve ?")) {
    ...
    deleteSelectedStudents() {
        ...
        if (confirm(this.currentLang === "ar" ? `?? ??? ????? ?? ??? ${checkboxes.length} ???????` : `Confirmez-vous la suppression de ${checkboxes.length} �l�ves ?`)) {
    ...
    downloadCollectiveRubricExcel() {
        try {
            ...
            alert(this.currentLang === "ar" ? "??? ????? ????? ???? ????!" : "�chec de l'exportation du bar�me en Excel !");
        }
    }
    ...
    getFicheTemplateData(sportId, grade, sessionNum) {
        ...
        if (sportId === "handball" || sportId.includes("hand")) {
            if (num === 1) {
                ...
                p2Situations = "?1: ????? ???????? ??? 04 ????? ??????? ?????? ?????? ?? ????? (?????? ??? ?????) (25?).<br>?2: ???? ????????? ????? ?? ??? ???? ??? ????? ?? ?????? ????? ????? (25?).<br>?3: ?????? ??????? ????? ??? ??????? ?? ??? ????? ????? ???? ???? ??? ????? ??? ??????? (30?).";
                p2Org = "??????? ???? ??? ????? 4 ????? ??????? ????? ????? ?????? ????? ?????.";
                p2Crit = "??? ???? ????? ??? ?????? ???????? ??? ???????? ????? ???????? ????????.";
            ...
            p2Situations = "?1: ??????? ??? ????? ???????? ??????? (?? ?????? ?????? ?????) ?? ?????? ????? (25?).<br>?2: ?????? ???? ????? (20? ?? 30?) ????? ??? ????????? ???????? ??????? ???????? (25?).<br>?3: ?????? ????? ?? ????? ?????? ?????? 60? ????? ???????? ???????? ?? ???? ??????? (30?).";
            p2Org = "????? ?????? ?????? ????? ?????? ????? ?????.";
            p2Crit = "???????? ?????? ????? ??? ???????? ???? ??? ????? ??????.";
            
            p3Situations = "??? ???? ???? ????? ??????? ??????? ??????? ??????? ????? (15?).<br>????? ????????? ??????? ?????? ?????????? ?????? ????????? (5?).";
            p3Org = "?????? ????? ??? ????? ?? ?????.";
            p3Crit = "???? ????? ???????? ???????.";
        } else {
